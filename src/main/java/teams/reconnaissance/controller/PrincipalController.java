...
public class PrincipalController {
    ...
    public void btnConnexion(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/teams/AuthView.fxml"));
    ...
    public void btnInscrire(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/teams/InscriptionView.fxml"));
